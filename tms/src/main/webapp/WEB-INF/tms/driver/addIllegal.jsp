...
<body class="gray-bg">
		...
		<div class="col-sm-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<form class="form-horizontal m-t" method="post" id="addIllegalForm">
						
						<div class="form-group">
							<label class="col-sm-3 control-label">违章司机：</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="illegalReson" name="illegalReson" placeholder="请输入违章原因"
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="recordDate" name="recordDate" class="form-control"
									type="text"
									class="layer-date laydate-icon">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">违章处罚费用：</label>
							<div class="col-sm-4">
								<input id="illegalCost" name="illegalCost" placeholder="请输入违章费用"
									class="form-control" type="text" class="valid">
							</div>
						</div>
	...
	var driverSuggest = $("#driverName").bsSuggest({
		...
		$(function() {
			...
			//外部js调用
			laydate({
				elem : '#recordDate', //目标元素。由于laydate.js封装了一个轻量级的选择器引擎，因此elem还允许你传入class、tag但必须按照这种方式 '#id .class'
