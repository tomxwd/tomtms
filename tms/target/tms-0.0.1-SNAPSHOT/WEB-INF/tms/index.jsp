				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"> <i class="fa fa-home"></i> <span
						...
						<%-- </shiro:hasPermission> --%>
							...
							<li><a class="J_menuItem" href="${ctx}/driver/toDriverList" data-index="0">维修记录</a></li>
							<li><a class="J_menuItem" href="${ctx}/driver/toDriverList" data-index="0">违章记录</a></li>
						</ul>
					</li>
					...
					<li><a href="#"> <i class="fa fa-home"></i> <span
						...
						<ul class="nav nav-second-level">
						<%-- <shiro:hasPermission name="user:addPage"> --%>
							<li><a class="J_menuItem" href="${ctx}/driver/toAddDriver" data-index="0">添加司机</a></li>
						<%-- </shiro:hasPermission>
						<shiro:hasPermission name="user:listPage"> --%>
							<li><a class="J_menuItem" href="${ctx}/driver/toDriverList" data-index="0">司机列表</a></li>
						<%-- </shiro:hasPermission> --%>
					...
					<shiro:hasPermission name="modular:addPage or modular:listPage">
						<li id="modular_li"><a href="#"> <i class="fa fa-home"></i> <span
